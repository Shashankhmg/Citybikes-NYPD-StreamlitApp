...
st.write("""
The **risk prediction model** helps **users ride safely, CitiBike optimize operations, and AXA create tailored insurance solutions**—resulting in a **safer and more efficient urban mobility ecosystem.** 
""")
